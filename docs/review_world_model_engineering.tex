...
├── docs/
│   ├── 文献综述_3D_与_全景重建.md
│   ├── COLMAP_与_Nerfstudio_教程.md
│   ├── review_world_model_theory.tex      # 本文配套的理论综述
│   └── review_world_model_engineering.tex # 本文（工程实践指南）
├── mipnerf360/
│   └── db/
...
与文档 \texttt{COLMAP\_与\_Nerfstudio\_教程.md} 的几何部分对应。
